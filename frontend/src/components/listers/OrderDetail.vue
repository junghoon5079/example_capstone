<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="CustomerAddr" v-model="item.customerAddr" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="ProductName" v-model="item.productName" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="ProjectPrice" v-model="item.projectPrice" :editMode="editMode" @change="change" />
            </div>
            <div>
